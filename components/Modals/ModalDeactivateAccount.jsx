            ...
            <Modal.Body>
                <div className="container">
                    <p className="pb-3 text-xs">
                        This will disable the customer’s account and they can no
                        longer login to e-services unless reactivated.
                    </p>
            ...
            <Modal.Footer justify="flex-end">
                <div className="flex py-2 space-x-2">
                    ...
                    <Button
                        type="submit"
                        // onClick={closeHandler}
                        className="px-5 py-2 text-white bg-red-600 rounded hover:opacity-50">
                        Deactivate
                    </Button>
                </div>
            </Modal.Footer>
